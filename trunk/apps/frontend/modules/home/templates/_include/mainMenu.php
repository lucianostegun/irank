...
<div class="item" style="background: url('/images/icon/options.png') 10px 6px no-repeat"><?php echo link_to('Configurações', 'sign/options', array('style'=>'background: none')) ?></div>
