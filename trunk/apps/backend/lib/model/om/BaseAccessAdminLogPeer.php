...
abstract class BaseAccessAdminLogPeer {
	...
	public static function doCountJoinUserAdmin(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(AccessAdminLogPeer::USER_ADMIN_ID, UserAdminPeer::ID);
	...
	public static function doSelectJoinUserAdmin(Criteria $c, $con = null)
	{
		...
		AccessAdminLogPeer::addSelectColumns($c);
		$startcol = (AccessAdminLogPeer::NUM_COLUMNS - AccessAdminLogPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		UserAdminPeer::addSelectColumns($c);

		$c->addJoin(AccessAdminLogPeer::USER_ADMIN_ID, UserAdminPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();

		while($rs->next()) {

			$omClass = AccessAdminLogPeer::getOMClass();
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getUserAdmin(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addAccessAdminLog($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initAccessAdminLogList();
				$obj2->addAccessAdminLog($obj1); 			}
			$results[] = $obj1;
		}
		return $results;
	}
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		AccessAdminLogPeer::addSelectColumns($c);
		$startcol2 = (AccessAdminLogPeer::NUM_COLUMNS - AccessAdminLogPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
