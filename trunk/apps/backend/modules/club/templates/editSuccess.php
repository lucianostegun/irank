<div class="wrapper">
	...
	<div class="widget">       
	    <ul class="tabs">
			...
			<?php echo submit_tag('salvar', array('class'=>'button blueB', 'style'=>'margin: 3px 10px', 'onclick'=>'$("#clubForm").submit()')); ?>
		</ul>
		<div class="tab_container">
			<div id="tab1" class="tab_content"><?php include_partial('club/tab/main', array('clubObj'=>$clubObj)) ?></div>
			<div id="tab2" class="tab_content"><?php include_partial('club/tab/ranking', array('clubObj'=>$clubObj)) ?></div>
			<div id="tab3" class="tab_content"><?php include_partial('club/tab/event', array('clubObj'=>$clubObj)) ?></div>
