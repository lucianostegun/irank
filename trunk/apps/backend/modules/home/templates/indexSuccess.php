...
<script type="text/javascript" src="/js/backend/plugins/charts/jquery.flot.orderBars.js"></script>
<script type="text/javascript" src="/js/backend/plugins/charts/jquery.flot.pie.js"></script>
<script type="text/javascript" src="/js/backend/plugins/charts/jquery.flot.resize.js"></script>
<script type="text/javascript" src="/js/backend/plugins/charts/jquery.sparkline.min.js"></script>

<script type="text/javascript" src="/js/backend/plugins/forms/uniform.js"></script>

<script type="text/javascript" src="/js/backend/plugins/forms/jquery.cleditor.js"></script>
<script type="text/javascript" src="/js/backend/plugins/forms/jquery.validationEngine-en.js"></script>
<script type="text/javascript" src="/js/backend/plugins/forms/jquery.validationEngine.js"></script>
<script type="text/javascript" src="/js/backend/plugins/forms/jquery.tagsinput.min.js"></script>
<script type="text/javascript" src="/js/backend/plugins/forms/autogrowtextarea.js"></script>
<script type="text/javascript" src="/js/backend/plugins/forms/jquery.maskedinput.min.js"></script>
<script type="text/javascript" src="/js/backend/plugins/forms/jquery.dualListBox.js"></script>
<script type="text/javascript" src="/js/backend/plugins/forms/jquery.inputlimiter.min.js"></script>
<script type="text/javascript" src="/js/backend/plugins/forms/chosen.jquery.min.js"></script>

<script type="text/javascript" src="/js/backend/plugins/wizard/jquery.form.js"></script>
<script type="text/javascript" src="/js/backend/plugins/wizard/jquery.validate.min.js"></script>
<script type="text/javascript" src="/js/backend/plugins/wizard/jquery.form.wizard.js"></script>

<script type="text/javascript" src="/js/backend/plugins/uploader/plupload.js"></script>
<script type="text/javascript" src="/js/backend/plugins/uploader/plupload.html5.js"></script>
<script type="text/javascript" src="/js/backend/plugins/uploader/plupload.html4.js"></script>
<script type="text/javascript" src="/js/backend/plugins/uploader/jquery.plupload.queue.js"></script>

<script type="text/javascript" src="/js/backend/plugins/tables/datatable.js"></script>
<script type="text/javascript" src="/js/backend/plugins/tables/tablesort.min.js"></script>
<script type="text/javascript" src="/js/backend/plugins/tables/resizable.min.js"></script>

<script type="text/javascript" src="/js/backend/plugins/ui/jquery.tipsy.js"></script>
<script type="text/javascript" src="/js/backend/plugins/ui/jquery.collapsible.min.js"></script>
<script type="text/javascript" src="/js/backend/plugins/ui/jquery.prettyPhoto.js"></script>
<script type="text/javascript" src="/js/backend/plugins/ui/jquery.progress.js"></script>
<script type="text/javascript" src="/js/backend/plugins/ui/jquery.timeentry.min.js"></script>

<script type="text/javascript" src="/js/backend/plugins/ui/jquery.colorpicker.js"></script>
<script type="text/javascript" src="/js/backend/plugins/ui/jquery.jgrowl.js"></script>
<script type="text/javascript" src="/js/backend/plugins/ui/jquery.breadcrumbs.js"></script>
<script type="text/javascript" src="/js/backend/plugins/ui/jquery.sourcerer.js"></script>

<script type="text/javascript" src="/js/backend/plugins/calendar.min.js"></script>
<script type="text/javascript" src="/js/backend/plugins/elfinder.min.js"></script>

<script type="text/javascript" src="/js/backend/custom.js"></script>

<script type="text/javascript" src="/js/backend/charts/chart.js"></script>
        ...
        <div class="wrapper">
        	<div class="controlB">
            	<ul>
                    ...
                    <li><a href="#" title=""><img src="/images/backend/icons/control/32/hire-me.png" alt="" /><span>Add new user</span></a></li>
    ...
    <div class="wrapper">
        ...
        <div class="widget chartWrapper">
            <div class="title"><img src="/images/backend/icons/dark/stats.png" alt="" class="titleIcon" /><h6>Chart</h6></div>
        ...
        <div class="widgets">
            <div class="oneTwo">
                ...
                <div class="widget">
                    <div class="title"><img src="/images/backend/icons/dark/users.png" alt="" class="titleIcon" /><h6>Partners list</h6></div>
                    <ul class="partners">
                        <li>

                            <a href="#" title="" class="floatL"><img src="/images/backend/user.png" alt="" /></a>
                            <div class="pInfo">
                                <a href="#" title=""><strong>Dave Armstrong</strong></a>
                                <i>Creative director at Google Inc. Zurich</i>	
                            </div>
                            <div class="pLinks">
                                <a href="#" title="Direct call" class="tipW"><img src="/images/backend/icons/pSkype.png" alt="" /></a>
                                <a href="#" title="Send an email" class="tipW"><img src="/images/backend/icons/pEmail.png" alt="" /></a>
                ...
                <div class="widget">
                    ...
                    <div class="title"><img src="/images/backend/icons/dark/stats.png" alt="" class="titleIcon" /><h6>Website statistics</h6></div>
                ...
                <div class="widget">
                    <div class="title"><img src="/images/backend/icons/dark/refresh4.png" alt="" class="titleIcon" /><h6>Latest updates</h6></div>
            ...
            <div class="oneTwo">
                ...
                <div class="widget">
                    <div class="title">
                    	<img src="/images/backend/icons/dark/money.png" alt="" class="titleIcon" />

                        <h6>Purchase info</h6>
                        <div class="topIcons">
                            <a href="#" class="tipS" title="Download statement"><img src="/images/backend/icons/downloadTop.png" alt="" /></a>
                            <a href="#" class="tipS" title="Print invoice"><img src="/images/backend/icons/printTop.png" alt="" /></a>
                            <a href="#" class="tipS" title="Edit"><img src="/images/backend/icons/editTop.png" alt="" /></a>
                        </div>
                    </div>
                    <div class="newOrder">

                        <div class="userRow">
                            <a href="#" title=""><img src="/images/backend/user.png" alt="" class="floatL" /></a>
                            <ul class="leftList">
                ...
                <!-- New users widget -->
                <div class="widget">
                    <div class="title"><img src="/images/backend/icons/dark/add.png" alt="" class="titleIcon" /><h6>New users</h6></div>
                    <div class="wUserInfo">
                        <a href="#" title="" class="wUserPic"><img src="/images/backend/user.png" alt="" /></a>
                        <ul class="leftList">
                ...
                <div class="widget">
                    <div class="title"><img src="/images/backend/icons/dark/timer.png" alt="" class="titleIcon" /><h6>My tasks</h6><div class="num"><a href="#" class="blueNum">+245</a></div></div>
                    <table cellpadding="0" cellspacing="0" width="100%" class="sTable taskWidget">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="actBtns"><a href="#" title="Update" class="tipS"><img src="/images/backend/icons/edit.png" alt="" /></a><a href="#" title="Remove" class="tipS"><img src="/images/backend/icons/remove.png" alt="" /></a></td>
                            </tr>
                            <tr>
        ...
        <!-- Events calendar -->
        <div class="widget">
            <div class="title"><img src="/images/backend/icons/dark/monthCalendar.png" alt="" class="titleIcon" /><h6>Events</h6></div>
        ...
        <div class="widget">
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                <thead>
                    <tr>
                        <td><img src="/images/backend/icons/tableArrows.png" alt="" /></td>
                ...
                <tbody>
                    <tr>
                        ...
                        <td align="center"><a href="images/big.png" title="" rel="lightbox"><img src="/images/backend/user.png" alt="" /></a></td>
    	...
    	<!-- Dynamic table -->
        <div class="widget">
            <div class="title"><img src="/images/backend/icons/dark/full2.png" alt="" class="titleIcon" /><h6>Dynamic table</h6></div>                          
