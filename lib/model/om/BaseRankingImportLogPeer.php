...
abstract class BaseRankingImportLogPeer {
	...
	public static function doCountJoinRankingRelatedByRankingId(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
		...
		$criteria->addJoin(RankingImportLogPeer::RANKING_ID, RankingPeer::ID);
	...
	public static function doCountJoinRankingRelatedByRankingIdFrom(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
		...
		$criteria->addJoin(RankingImportLogPeer::RANKING_ID_FROM, RankingPeer::ID);
	...
	public static function doSelectJoinRankingRelatedByRankingId(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		RankingImportLogPeer::addSelectColumns($c);
		$startcol = (RankingImportLogPeer::NUM_COLUMNS - RankingImportLogPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		RankingPeer::addSelectColumns($c);

		$c->addJoin(RankingImportLogPeer::RANKING_ID, RankingPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();

		while($rs->next()) {

			$omClass = RankingImportLogPeer::getOMClass();
			...
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getRankingRelatedByRankingId(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addRankingImportLogRelatedByRankingId($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initRankingImportLogListRelatedByRankingId();
				$obj2->addRankingImportLogRelatedByRankingId($obj1); 			}
			$results[] = $obj1;
		}
		return $results;
	}
	...
	public static function doSelectJoinRankingRelatedByRankingIdFrom(Criteria $c, $con = null)
	{
		$c = clone $c;
		...
		$c->addJoin(RankingImportLogPeer::RANKING_ID_FROM, RankingPeer::ID);
		$rs = BasePeer::doSelect($c, $con);
		$results = array();
		...
		while($rs->next()) {
			...
			$newObject = true;
			foreach($results as $temp_obj1) {
				$temp_obj2 = $temp_obj1->getRankingRelatedByRankingIdFrom(); 				if ($temp_obj2->getPrimaryKey() === $obj2->getPrimaryKey()) {
					$newObject = false;
										$temp_obj2->addRankingImportLogRelatedByRankingIdFrom($obj1); 					break;
				}
			}
			if ($newObject) {
				$obj2->initRankingImportLogListRelatedByRankingIdFrom();
				$obj2->addRankingImportLogRelatedByRankingIdFrom($obj1); 			}
			$results[] = $obj1;
		}
		return $results;
	}
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		RankingImportLogPeer::addSelectColumns($c);
		$startcol2 = (RankingImportLogPeer::NUM_COLUMNS - RankingImportLogPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		...
		while($rs->next()) {
			...
			for ($j=0, $resCount=count($results); $j < $resCount; $j++) {
				$temp_obj1 = $results[$j];
				$temp_obj3 = $temp_obj1->getRankingRelatedByRankingIdFrom(); 				if ($temp_obj3->getPrimaryKey() === $obj3->getPrimaryKey()) {
					$newObject = false;
					$temp_obj3->addRankingImportLogRelatedByRankingIdFrom($obj1); 					break;
				}
			}

			if ($newObject) {
				$obj3->initRankingImportLogListRelatedByRankingIdFrom();
				$obj3->addRankingImportLogRelatedByRankingIdFrom($obj1);
			}
	...
	public static function doCountJoinAllExceptRankingRelatedByRankingId(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
	...
	public static function doCountJoinAllExceptRankingRelatedByRankingIdFrom(Criteria $criteria, $distinct = false, $con = null)
	{
				$criteria = clone $criteria;
	...
	public static function doSelectJoinAllExceptRankingRelatedByRankingId(Criteria $c, $con = null)
	{
		$c = clone $c;
	...
	public static function doSelectJoinAllExceptRankingRelatedByRankingIdFrom(Criteria $c, $con = null)
	{
		$c = clone $c;
