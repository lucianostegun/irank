...
class sfParameterHolder
{
   ...
   */
  public function & get($name, $default = null, $ns = 'iRank')
  {
    if (!$ns)
    {
   ...
   */
  public function getNames($ns = 'iRank')
  {
    if (!$ns)
    {
      $ns = $this->default_namespace;
   ...
   */
  public function & getAll($ns = 'iRank')
  {
    if (!$ns)
    {
      $ns = $this->default_namespace;
   ...
   */
  public function has($name, $ns = 'iRank')
  {
    if (!$ns)
    {
      $ns = $this->default_namespace;
   ...
   */
  public function & remove($name, $ns = 'iRank')
  {
    if (!$ns)
    {
      $ns = $this->default_namespace;
   ...
   * @return void
   */
  public function & removeNamespace($ns = 'iRank')
  {
    if (!$ns)
    {
      $ns = $this->default_namespace;
   ...
   * @return void
   */
  public function set($name, $value, $ns = 'iRank')
  {
    if (!$ns)
    {
      $ns = $this->default_namespace;
   ...
   * @return void
   */
  public function setByRef($name, & $value, $ns = 'iRank')
  {
    if (!$ns)
    {
      $ns = $this->default_namespace;
   ...
   * @return void
   */
  public function add($parameters, $ns = 'iRank')
  {
   ...
   * @return void
   */
  public function addByRef(& $parameters, $ns = 'iRank')
  {
    if (!$ns)
    {
      $ns = $this->default_namespace;
