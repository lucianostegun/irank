...
//#}
   ...
   */
	...
	*/
	...
	this.setColMask=function(mskStr){
		this.cellMask=mskStr.split(this.delim)
		for (var i=0; i < this.cellMask.length; i++)
			this.cellMask[i]=this.cellMask[i]._dhx_trim();
	}
/**
	...
	_parseHead:function(xmlDoc){
		...
		if (hheadCol.length){
			...
			if (headCol.length > 0){
				...
				var calls = ["", awidthmet, "setColTypes", "setColAlign", "setColMask", "setColSorting", "setColumnColor", "",
					"", "setColumnIds"];
...
(function(){
	...
	var columns_map=[
		...
		{name:"mask", 	def:"", 		operation:"cellMask",		type:direct_set		},
