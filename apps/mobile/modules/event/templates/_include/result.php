<table width="100%" border="0" cellspacing="1" cellpadding="0">
  ...
  <tr class="boxcontent">
    ...
    <td><?php echo input_tag('eventPosition'.$peopleId, $eventPlayerObj->getEventPosition(), array('size'=>2, 'maxlength'=>2, 'tabindex'=>($key+1+$recordCount), 'onfocus'=>'handleOnFocus(this)', 'onblur'=>'handleOnBlur(this)', 'id'=>'eventEventPosition'.$peopleId)) ?></td>
    <td><?php echo input_tag('prize'.$peopleId, Util::formatFloat($eventPlayerObj->getPrize(), true), array('size'=>5, 'maxlength'=>7, 'tabindex'=>($key+1+$recordCount*2), 'onfocus'=>'handleOnFocus(this)', 'onblur'=>'handleOnBlur(this)', 'style'=>'text-align: right', 'id'=>'eventPrize'.$peopleId)) ?></td>
    <td><?php echo input_tag('rebuy'.$peopleId, Util::formatFloat($eventPlayerObj->getRebuy(), true), array('size'=>5, 'maxlength'=>7, 'tabindex'=>($key+1+$recordCount*3), 'onfocus'=>'handleOnFocus(this)', 'onblur'=>'handleOnBlur(this)', 'style'=>'text-align: right', 'id'=>'eventRebuy'.$peopleId)) ?></td>
    <td><?php echo input_tag('addon'.$peopleId, Util::formatFloat($eventPlayerObj->getAddon(), true), array('size'=>5, 'maxlength'=>7, 'tabindex'=>($key+1+$recordCount*4), 'onfocus'=>'handleOnFocus(this)', 'onblur'=>'handleOnBlur(this)', 'style'=>'text-align: right', 'id'=>'eventAddon'.$peopleId)) ?></td>
  </tr>
  <?php
  	endforeach;
