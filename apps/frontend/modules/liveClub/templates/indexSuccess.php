...
<div id="houseList">
	...
	?>
	<div class="house">
		<div class="logo"><?php echo image_tag('club/'.$fileNameLogo) ?></div>
		<div class="info">
			<div class="profile">
			...
			<div class="links">
				<div class="link" onmouseover="this.addClassName('hover')" onmouseout="this.removeClassName('hover')" onclick="goToPage('rankingLive', 'index', 'clubId', <?php echo $clubId ?>)">Torneios</div>
