...
?>
	...
	<div class="formRow">
		<label>Pessoa</label>
		<div class="formRight"><?php echo input_tag('peopleName', $userAdminObj->getPeople()->getName(), array('size'=>35, 'maxlength'=>200, 'id'=>'userToolsPeopleName')) ?></div>
		<div class="clear"></div>
	</div>

	<div class="formRow">
		<label>Username</label>
		<div class="formRight"><?php echo input_tag('username', $userAdminObj->getUsername(), array('maxlength'=>15, 'id'=>'userToolsUsername')) ?></div>
		<div class="clear"></div>
	</div>
	...
	<div style="display: <?php echo ($password?'none':'block') ?>" id="passwordFieldDiv">
		<div class="formRow">
			<label>Senha</label>
			<div class="formRight"><?php echo input_password_tag('newPassword', ($password?'******':''), array('maxlength'=>15, 'id'=>'userToolsNewPassword')) ?></div>
			<div class="clear"></div>
		</div>

		<div class="formRow">
			<label>Confirmação</label>
			<div class="formRight"><?php echo input_password_tag('passwordConfirm', ($password?'******':''), array('maxlength'=>15, 'id'=>'userToolsPasswordConfirm')) ?></div>
			<div class="clear"></div>
		</div>
	</div>
