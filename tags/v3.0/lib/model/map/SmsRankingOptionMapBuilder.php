...
class SmsRankingOptionMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.SmsRankingOptionMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('sms_ranking_option');
		$tMap->setPhpName('SmsRankingOption');
