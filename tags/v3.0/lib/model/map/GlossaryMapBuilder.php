...
class GlossaryMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.GlossaryMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('glossary');
		$tMap->setPhpName('Glossary');

		$tMap->setUseIdGenerator(true);

		$tMap->setPrimaryKeyMethodInfo('glossary_SEQ');

		$tMap->addPrimaryKey('ID', 'Id', 'int', CreoleTypes::INTEGER, true, null);

		$tMap->addColumn('TERM', 'Term', 'string', CreoleTypes::VARCHAR, false, null);
