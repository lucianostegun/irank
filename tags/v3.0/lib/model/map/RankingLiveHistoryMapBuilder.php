...
class RankingLiveHistoryMapBuilder {

	
	const CLASS_NAME = 'lib.model.map.RankingLiveHistoryMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap = $this->dbMap->addTable('ranking_live_history');
		$tMap->setPhpName('RankingLiveHistory');
