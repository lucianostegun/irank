...
<div class="innerMenu" style="display: <?php echo ($isNew && $actionName!='index'?'none':'block') ?>" id="mainMenuEvent">
	...
	<?php else: ?>
	<div onclick="cloneEventPersonal()" class="subitem"><div class="label icon clone"><?php echo __('button.cloneEvent') ?></div></div>

   	<div onclick="doDeleteEventPersonal()" class="subitem"><div class="label icon delete"><?php echo __('button.deleteEvent') ?></div></div>
	<?php endif; ?>
</div>