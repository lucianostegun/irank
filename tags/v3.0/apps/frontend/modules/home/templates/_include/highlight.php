...
<div class="homeHighlight">
	<div class="content">
		...
		<div class="contentItem <?php echo ($activeHighlight==5?'active':'') ?>" id="homeHighlight5" style="background: url('/images/home/highlight/math.jpg') left center no-repeat"></div>
