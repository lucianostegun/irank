...
?>
	...
	<div class="formRow">
		...
		<div class="formRight"><?php echo checkbox_tag('encodeEmailToUTF8', true, $encodeEmailToUTF8, array('id'=>'controlPanelEncodeEmailToUTF8')) ?></div>
		<div class="clear"></div>
	</div>
	<div class="formRow">
		<label>Decodificar UTF-8</label>
		<div class="formRight"><?php echo checkbox_tag('decodeEmailFromUTF8', true, $decodeEmailFromUTF8, array('id'=>'controlPanelDecodeEmailFromUTF8')) ?></div>
		<div class="clear"></div>
	</div>