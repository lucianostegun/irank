...
<table width="100%" class="form">
	<tr>
		...
		<td>
			...
			<?php endif; ?>
			<br/>
			<h5 id="quickEventSatelliteHeader" class="<?php echo ($rankingLiveObj->getNoRanking()?'hidden':'') ?>">
				Satélite
				<?php echo link_to('Exibir', '#toggleSatelliteDetails()', array('id'=>'satelliteDetailsLink')) ?>
				<hr/>
				<br/>
			</h5>
			
			<div id="satelliteDetailsDiv">
