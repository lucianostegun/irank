	...
	$.fn.dataTable = function( oInit )
	{
		...
		function classSettings ()
		{
			...
			this.oLanguage = {
				...
				"sLengthMenu": "<span class='itemsPerPage'>Registros por página:</span> _MENU_",
				...
				"sInfoPostFix": "",
				"sInfoThousands": ",",
				"sSearch": "<span class='itemsPerPage'>Pesquisa:</span>",
				"sUrl": "",
				"oPaginate": {
					"sFirst":    "Primeira",
					"sPrevious": "Anterior",
			 ...
			 */
			this.aLengthMenu = [ 15, 25, 50, 100, 200 ];
		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" placeholder="Pesquisa rápida..." /><div class="srch"></div>';
