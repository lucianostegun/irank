...
function eXcell_ed(cell){
	...
	this.edit=function(){
		...
		this.obj.wrap="soft";
		// Editado por Luciano Stegun
		this.obj.style.textAlign=this.grid.cellAlign[this.cell._cellIndex];
		var mask = this.grid.cellMask[this.cell._cellIndex];
		
		if( mask )
			eval('this.obj.onkeyup = '+mask+';');
...
eXcell_ch.prototype.setValue=function(val){
	...
	this.setCValue("<img src='"+this.grid.imgURL+"item_chk"+val
		+".png' onclick='new eXcell_ch(this.parentNode).changeState(true); (arguments[0]||event).cancelBubble=true; '>",
		this.cell.chstate);
}
//#}
//#ra_excell:04062008{
...
eXcell_ra.prototype.setValue=function(val){
	...
	this.setCValue("<img src='"+this.grid.imgURL+"radio_chk"+val+".png' onclick='new eXcell_ra(this.parentNode).changeState(false);'>",
		this.cell.chstate);
}
//#}
//#txt_excell:04062008{
