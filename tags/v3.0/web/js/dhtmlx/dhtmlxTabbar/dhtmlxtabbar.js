...
function dhtmlXTabBar(parentObject,mode,height){
	...
	this._styles={
		"default":{ left:3, right:3, select_shift:0, select_top:1, margin:2, offset:5, tab_color:"#F4F3EE", data_color:"#EFEFEF" },
		...
		"dhx_web":{ left:3, right:3, select_shift:1, select_top:0, margin:2, offset:1, tab_color:"#0F0" , data_color:"F00" }
	};
...
function onTabContentLoaded(tabId, dhtmlXTabBarObj){

	dhtmlXTabBarObj.cells(tabId).show();
}
