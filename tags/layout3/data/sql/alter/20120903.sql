CREATE SEQUENCE ranking_subscribe_request_seq;
CREATE TABLE ranking_subscribe_request (
    id INTEGER NOT NULL DEFAULT nextval('ranking_subscribe_request_seq'::regclass) PRIMARY KEY,
    ...
    CONSTRAINT ranking_subscribe_request_FK_1 FOREIGN KEY (user_site_id) REFERENCES user_site (id),
    CONSTRAINT ranking_subscribe_request_FK_2 FOREIGN KEY (user_site_id_owner) REFERENCES user_site (id),
    CONSTRAINT ranking_subscribe_request_FK_3 FOREIGN KEY (ranking_id) REFERENCES ranking (id)
);
