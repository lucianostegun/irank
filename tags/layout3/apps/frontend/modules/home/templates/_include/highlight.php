...
<div class="homeHighlight">
	<div class="content">
		...
		<div class="contentItem <?php echo ($activeHighlight==5?'active':'') ?>" id="homeHighlight5" style="background: url('/images/home/highlight/newApp.jpg') left center no-repeat"></div>
		<?php
		...
		<div class="descriptionBorder">
			...
			<div class="descriptionText">
			 	<ul>
					...
					<li id="contentItemText2" class="<?php echo ($activeHighlight==2?'active':'') ?>"><h1><?php echo link_to('iRank no Facebook', 'http://www.facebook.com/irankpoker', array('target'=>'_blank')) ?></h1><p>Agora o <b>iRank</b> também está no Facebook.<br/>Acesse e curta nossa página e fique por dentro de todas as novidades do site.</p></li>
