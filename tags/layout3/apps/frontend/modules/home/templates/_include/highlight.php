...
<div class="homeHighlight">
	<div class="content">
		...
		<div class="contentItem <?php echo ($activeHighlight==1?'active':'') ?>" id="homeHighlight1" style="background: url('/images/home/highlight/luckyTshirt.jpg') left center no-repeat"></div>
		...
		<div class="descriptionBorder">
			...
			<div class="descriptionText">
			 	<ul>
					<li id="contentItemText1" class="<?php echo ($activeHighlight==1?'active':'') ?>"><h1><?php echo link_to('Camiseta da sorte', '/store/details?IRKTS-005=') ?></h1><p>Aproveite essa edição especial por <b>tempo limitado</b>.<br/>Compre já sua <b>Lucky Tshirt</b> para começar 2013 com muita sorte!</p></li>
