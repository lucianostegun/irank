...
<div class="homeHighlight">
	<div class="content">
		...
		<div class="contentItem <?php echo ($activeHighlight==1?'active':'') ?>" id="homeHighlight1" style="background: url('/images/home/highlight/soon.jpg') left center no-repeat"></div>
		
		<div class="contentItem <?php echo ($highlight==2?'active':'') ?>" id="homeHighlight2" style="background: url('/images/home/highlight/welcomeChips.png') right top no-repeat">
		...
		<div class="descriptionBorder">
			...
			<div class="descriptionText">
			 	<ul>
					<li id="contentItemText1" class="<?php echo ($activeHighlight==1?'active':'') ?>"><h1>Em breve...</h1><p>Estamos preparando uma super novidade para você.<br/>Dentro de poucos dias você mudará seu estilo de jogar poker. <b>Aguarde...</b></p></li>
					...
					<li id="contentItemText3" class="<?php echo ($activeHighlight==3?'active':'') ?>"><h1><?php echo link_to('iRank no Facebook', 'http://www.facebook.com/irankpoker', array('target'=>'_blank')) ?></h1><p>Agora o <b>iRank</b> também está no Facebook.<br/>Acesse e curta nossa página para concorrer a prêmios.</p></li>
