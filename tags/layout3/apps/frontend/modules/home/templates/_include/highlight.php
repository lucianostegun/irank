...
<div class="homeHighlight">
	<div class="content">
		...
		<div class="contentItem <?php echo ($activeHighlight==1?'active':'') ?>" id="homeHighlight1" style="background: url('/images/home/highlight/fimDoMundo.jpg') left center no-repeat"></div>
		...
		<div class="descriptionBorder">
			...
			<div class="descriptionText">
			 	<ul>
					<li id="contentItemText1" class="<?php echo ($activeHighlight==1?'active':'') ?>"><h1><?php echo link_to('Promoção fim do mundo', '/blog/promocao-fim-do-mundo') ?></h1><p>Faça seu cadastro, crie seu ranking, chame seus amigos e torça para o mundo não acabar para concorrer a um <b>Kit Poker iRank</b>.</p></li>
