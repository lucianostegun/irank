...
/**
 * Subclasse de representação de objetos da tabela 'purchase_transaction'.
 *
 * 
 *
 * @package lib.model
 */ 
class PurchaseTransaction extends BasePurchaseTransaction
{
    ...
    public function save($con=null){
    	...
    	try{
			...
			parent::save();
       		...
       		Log::quickLog('purchase_transaction', $this->getPrimaryKey(), $isNew, $columnModifiedList, get_class($this));
        } catch ( Exception $e ) {
        	
            Log::quickLogError('purchase_transaction', $this->getPrimaryKey(), $e);
        }
    }
}
