...
function dhtmlXGridCellObject(obj){
	 ...
	 this.getInputId = function(){
		 ...
		 if( this.obj.id )
			 ...
			 inputId = 'gridboxCell'+(++_inputId);

		 return inputId;
	 }
	 
	 this.getCellId = function(rowId, cellIndex){

		 var gridboxId = this.grid.entBox.id.replace('Obj', '');
		 cellId = gridboxId+rowId+'_'+(cellIndex);

		 return cellId;
	 }	
	
	
 this.destructor=function(){this.cell.obj=null;this.cell=null;this.grid=null;this.base=null;return null};this.cell=obj;this.getValue=function(){if ((this.cell.firstChild)&&(this.cell.firstChild.tagName == "TEXTAREA"))
 ...
 getInput:function(){if (this.obj && (this.obj.tagName=="INPUT" || this.obj.tagName=="TEXTAREA")) return this.obj;
 
 var inps=(this.obj||this.cell).getElementsByTagName("TEXTAREA");
 if (!inps.length)inps=(this.obj||this.cell).getElementsByTagName("INPUT");return inps[0]}};
 
 // Código alterado Luciano Stegun
 dhtmlXGridCellObject.prototype.setValue=function(val){
	 
	 var rowId = this.cell.parentNode.idd;
	 this.cell.id = this.getCellId(rowId, this.cell._cellIndex);
 ...
 dhtmlXGridCellObject.prototype.getTitle=function(){return (_isIE ? this.cell.innerText : this.cell.textContent)};dhtmlXGridCellObject.prototype.setCValue=function(val, val2){this.cell.innerHTML=val;this.grid.callEvent("onCellChanged", [
 ...
 this.edit=function(){
	 ...
	 // Código alterado Luciano Stegun
	 _lastCellId = this.getInputId();
	 this.obj.setAttribute("id", _lastCellId );
	 ...
	 if (_isFF){this.obj.style.overflow="visible";if ((this.grid.multiLine)&&(this.obj.offsetHeight >= 18)&&(this.obj.offsetHeight < 40)){this.obj.style.height="36px";this.obj.style.overflow="scroll"}};this.obj.onselectstart=function(e){if (!e)e=event;e.cancelBubble=true;return true};if (_isIE)this.obj.focus();this.obj.focus()
 };
 ...
 this.setValue=function(val){
	 ...
	 if (!val||val.toString()._dhx_trim() == ""){val=" ";this.cell._clearCell=true}else
 ...
 };this.detach=function(){return this.val != this.getValue()};this.edit=null};eXcell_ch.prototype=new eXcell;
 ...
 eXcell_ch.prototype.setValue=function(val){
	 ...
	 if (val){val=val.toString()._dhx_trim();if ((val == "false")||(val == "0"))
 ...
 this.cell._cellIndex,
 (this.val != '1')
 ])}else {this.editor=null}};this.edit=null};eXcell_ra.prototype=new eXcell_ch;
 ...
 function eXcell_txt(cell){if (cell){
	 this.cell=cell;this.grid=this.cell.parentNode.grid};
 ...
 this.setValue=function(val){
	 ...
	 this.cell._brval=val;if (!val||val.toString()._dhx_trim() == "")
		 
 val=" ";this.setCTxtValue(val)}};eXcell_txttxt.prototype=new eXcell_txt;
...
// Código alterado Luciano Stegun
 ...
 };if (this.list.parentNode)this.list.parentNode.removeChild(this.list);if (this.obj.parentNode)this.obj.parentNode.removeChild(this.obj);return this.val != this.getValue()}};eXcell_co.prototype=new eXcell;eXcell_co.prototype.getText=function(){return this.cell.innerHTML};
 ...
 eXcell_co.prototype.setValue=function(val){
	 ...
	 if (typeof (val)== "object"){var optCol = this.grid.xmlLoader.doXPath("./option", val);if (optCol.length)this.cell._combo=new dhtmlXGridComboObject();for (var j = 0;j < optCol.length;j++)this.cell._combo.put(optCol[j].getAttribute("value"),
 optCol[j].firstChild
 ...
 return out}};this.isDisabled=function(){return true}};eXcell_img.prototype=new eXcell;eXcell_img.prototype.getTitle=function(){return this.cell._brval
	...
	var title = val;if (val.indexOf("^")!= -1){var ar = val.split("^");val=ar[0]
